...
import software.amazon.awssdk.services.greengrassv2.model.Cluster;
import software.amazon.awssdk.services.greengrassv2.model.ClusterStatus;
...
import static software.amazon.greengrassv2.cluster.TestUtils.TEST_NEXT_TOKEN;
...
public class ListHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        doReturn(ListClustersResponse.builder()
                .clusters(ImmutableList.of(Cluster.builder()
        ...
        assertThat(response.getResourceModels().get(0).getClusterArn()).isEqualTo(TEST_CLUSTER_ARN);
    ...
    @ParameterizedTest
    @MethodSource("provideListClustersExceptionsAndExpectedCfnExceptions")
    public void handle_request_WhenServiceClientThrowsException_ThenTranslateToCfnException(
        ...
        order.verify(greengrassV2Client, times(1)).listClusters(any(ListClustersRequest.class));
        order.verifyNoMoreInteractions();
    }

    private static Stream<Arguments> provideListClustersExceptionsAndExpectedCfnExceptions() {
        return Stream.of(
