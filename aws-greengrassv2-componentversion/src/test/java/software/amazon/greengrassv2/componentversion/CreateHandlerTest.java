...
public class CreateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        CreateComponentVersionResponse createComponentVersionResponse = CreateComponentVersionResponse.builder()
                .build();

        DescribeComponentResponse describeComponentResponseWithCreating = DescribeComponentResponse.builder()
                .build();

        DescribeComponentResponse describeComponentResponseWithActive = DescribeComponentResponse.builder()
                .build();

        doReturn(createComponentVersionResponse, describeComponentResponseWithCreating, describeComponentResponseWithActive)
                .when(proxy)
    ...
    @Test
    public void handleRequest_ThrowException_When_Component_in_wrong_status() {
        final CreateHandler handler = new CreateHandler();
        ...
        doReturn(createComponentVersionResponse, describeComponentResponseWithCreating)
                .when(proxy)
                .injectCredentialsAndInvokeV2(ArgumentMatchers.any(), ArgumentMatchers.any());
